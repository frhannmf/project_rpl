...
@section('title', 'Form Pengumpulan Ijazah SMA - SILANI STIS')
...
<div class="container">
  <div class="row my-5">
    <div class="col-md-6 offset-md-3">
      <div class="card">
        <div class="card-body">
          <h3 class="mb-3">Form Pengumpulan Ijazah SMA</h3>          
          <form method="POST" action="{{route('handle_submit_sma')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="d-flex justify-content-between align-items-center gap-2">
              <button type="submit" class="btn btn-primary flex-grow-1">Buat Jadwal Pengumpulan</button>
