        ...
        <tbody>
          @foreach ($forms as $form)
            <tr>
              ...
              <td>{{$form['approve']==null?'Diproses':($form['approve']?'Diterima':'Ditolak')}}</td>
              <td>{{$form['approve']==true?'Silahkan ke kampus pada tanggal yang telah ditentukan':$form['reason']}}</td>
            </tr>
          @endforeach
        </tbody>
      </table>
